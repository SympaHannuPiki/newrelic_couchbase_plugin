...
# description: Couchbase plugin for New Relic
# processname: newrelic_couchbase_plugin
...
# PLUGIN_PATH=/opt/newrelic/newrelic_couchbase_plugin
...
PLUGIN_NAME="New Relic Couchbase Plugin"
